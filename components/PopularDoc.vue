<template>
  <nuxt-link :to="linkTo" class="transition duration-500 col-span-1 flex shadow-sm rounded-md text-white bg-gradient-to-tr
            transform cursor-pointer py-3"
            :class="`from-${fromColor} to-${toColor} hover:from-${toColor} hover:to-${fromColor}`"
  >
